...
})({"6q6ZL":[function(require,module,exports) {
"use strict";
...
var r = /*#__PURE__*/ function(t2) {
    var r1, e1;
    function l1(i1) {
        var r2, e2, l, n, s = void 0 === i1 ? {} : i1, c = s.lerp, d = void 0 === c ? .1 : c, h = s.smooth, a = void 0 === h || h, u = s.direction, f = void 0 === u ? "vertical" : u;
        (n = t2.call(this) || this).onResize = function(t) {
            ...
            var o, i3, r3 = t.deltaY, e = t.originalEvent;
            n.stopped ? e.preventDefault() : (n.smooth && !e.ctrlKey && e.preventDefault(), n.targetScroll -= r3, n.targetScroll = (i3 = n.limit, (o = n.targetScroll) < 0 ? 0 : o > i3 ? i3 : o));
        }, n.onScroll = function(t) {
            n.scrolling && n.smooth || (n.targetScroll = n.scroll = "horizontal" === n.direction ? window.scrollX : window.scrollY, n.notify());
    ...
    return n1.start = function() {
        ...
        var t;
        this.smooth && !this.stopped && (this.scroll = (1 - (t = this.lerp)) * this.scroll + t * this.targetScroll, Math.round(this.scroll) === Math.round(this.targetScroll) && (this.scroll = this.targetScroll), this.scrolling && ("horizontal" === this.direction ? window.scrollTo(this.scroll, 0) : window.scrollTo(0, this.scroll), this.notify()), this.scrolling = this.scroll !== this.targetScroll);
    }, n1.notify = function() {
        this.emit("scroll", {
            scroll: this.scroll,
            limit: this.limit
        ...
        var i4, r4 = (void 0 === o ? {} : o).offset, e = void 0 === r4 ? 0 : r4;
        ...
        this.targetScroll = i4 += e, this.scrolling = !0, this.smooth || (this.scroll = i4);
    }, l1;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6q6ZL","3JeLG"], "3JeLG", "parcelRequiredfe1")
